...
export default function Home() {
  return (
    <BasicLayout>
      <section className="text-dark-blue body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h2 className="text-xs text-dark-orange tracking-widest font-medium title-font mb-1">SOCIAL BUSINESS</h2>
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-dark-light">Mejora tu negocio con otros negocios</h1>
          ...
          <div className="flex flex-wrap">
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-dark-orange border-opacity-60">
              <h2 className="text-lg sm:text-xl text-dark-light font-medium title-font mb-2">Emprendedores</h2>
            ...
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-dark-orange border-opacity-60">
              <h2 className="text-lg sm:text-xl text-dark-light font-medium title-font mb-2">Buscar</h2>
            ...
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-dark-orange border-opacity-60">
              <h2 className="text-lg sm:text-xl text-dark-light font-medium title-font mb-2">Brinda Servicios</h2>
            ...
            <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-dark-orange border-opacity-60">
              <h2 className="text-lg sm:text-xl text-dark-light font-medium title-font mb-2">Servicios</h2>
